...
* [Accédez aux données du profil client en temps réel à l’aide du tutoriel sur l’API Profile](https://docs.adobe.com/content/help/en/experience-platform/profile/api/getting-started.html)
